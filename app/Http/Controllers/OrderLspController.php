...
class OrderLspController extends Controller
{
    ...
    public function order(Request $request)
    {
        ...
        //     'lsp_id' => 'required',
        // ]);
        // Cek apakah user ini adalah pelanggan pertama
$order = Order::where('noOffer', $request->noOffer)->first();
$isFirstCustomer = !$order || !UserOrder::where('order_id', $order->id)->exists();
...
if ($request->shipmentType !== 'LCL' || $isFirstCustomer) {
