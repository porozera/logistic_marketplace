          ...
          <form action="service-add" method="post">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="code" id="code" placeholder="Masukkan kode layanan" value="{{ old('code') }}">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="serviceName" id="serviceName" placeholder="Masukkan nama layanan" value="{{ old('name') }}">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" id="price" placeholder="Masukkan harga layanan" value="{{ old('weight') }}">
                    {{-- <small class="form-text text-muted">Please enter your Password</small> --}}
                </div>
            </div>
            <div class="form-group">
                <label class="form-label" for="description">Deskripsi</label>
                <textarea class="form-control" id="description" name="description" rows="5" placeholder="Masukkan deskripsi layanan" value="{{ old('desription') }}"></textarea>
            </div>
