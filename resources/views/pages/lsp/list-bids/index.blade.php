...
<div class="pc-container">
    <div class="pc-content">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-12">
              <h3 class="m-b-10">List Bidding</h3>
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover" id="pc-dt-simple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($bid->loadingDate)->translatedFormat('l, d F Y')}}</td>
                                    <td>{{ \Carbon\Carbon::parse($bid->shippingDate)->translatedFormat('l, d F Y')}}</td>
