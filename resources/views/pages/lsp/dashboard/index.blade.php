                            ...
                            <div class="col-sm-12 col-md">
                                <div class="card">
                                    <div class="card-body text-center">
                                            <p class="">Gabung muatan lewat Open Container!</p>
                                            <a href="/opencontainer" class="btn btn-primary">Pesan Open Container</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="/trackings/{{$item->id}}"><small>Track</small></a></td>
                                        </tr>
                                        @endforeach
                                    @endif
                                </tbody>
