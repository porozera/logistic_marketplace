                ...
                <div class="card card-hover mb-3 shadow-sm p-3" style="border-radius: 10px">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center mt-3">
                            ...
                            <div class="col-md-6  gap-2 text-end" style="display:flex; justify-content: flex-end">
                                <button type="button"
                                    ...
                                    <i
                                        class="ti {{ $order->shipmentMode == 'laut' ? 'ti-sailboat' : 'ti-truck-delivery' }} me-1"></i>
                        ...
                        <div class="row align-items-center mt-3">
                            ...
                            <div class="col-md-6  gap-2 text-end" style="display:flex; justify-content: flex-end">
                                <a href=" {{ route('order-management.showOffer', $order->id) }} " class="btn btn-primary"
                                    style="border-radius: 10px; width:250px">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
