          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Province List</li>
              </ul>
            </div>
            <div class="col-md-12">
          ...
          <div class="card table-card">
            <div class="card-body">
              <div class="text-end p-4 pb-0">
                <a href="province-add" class="btn btn-primary d-inline-flex align-item-center">
                ...
                <table class="table table-hover" id="pc-dt-simple">
                  <thead>
                    <tr>
                      <th></th>
                      <th>Nama Provinsi</th>
                      <th>Kode Wilayah Administrasi</th>
                      ...
                      <td class="text-center">
                        <ul class="list-inline me-auto mb-0">
                          <li class="list-inline-item align-bottom">
                            <a href="{{ url('province/'.$item->id.'/edit') }}" class="avtar avtar-xs btn-link-primary">
...
<script>
  function confirmDelete(id) {
      ...
      form.action = "/province/" + id; // Mengatur action form delete
