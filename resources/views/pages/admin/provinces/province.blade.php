          ...
          <div class="card table-card">
            <div class="card-body">
              <div class="text-end p-4 pb-0">
                <a href="/admin/province-add" class="btn btn-primary d-inline-flex align-item-center">
                      ...
                      <td class="text-center">
                        <ul class="list-inline me-auto mb-0">
                          <li class="list-inline-item align-bottom">
                            <a href="{{ url('/admin/province/'.$item->id.'/edit') }}" class="avtar avtar-xs btn-link-primary">
...
<script>
  function confirmDelete(id) {
      ...
      form.action = "/admin/province/" + id; // Mengatur action form delete
