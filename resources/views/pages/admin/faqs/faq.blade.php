          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">FAQs Data</li>
              </ul>
            </div>
            <div class="col-md-12">
                      ...
                      <td class="text-center">
                        <ul class="list-inline me-auto mb-0">
                          <li class="list-inline-item align-bottom">
                            <a href="{{ url('/admin/faq/'.$item->id.'/edit') }}" class="avtar avtar-xs btn-link-primary">
...
<script>
  function confirmDelete(id) {
      ...
      form.action = "/admin/faq/" + id; // Mengatur action form delete
