          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Data Frequently Asked Questions</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card table-card">
            <div class="card-body">
              <div class="text-end p-4 pb-0">
                <a href="faq-add" class="btn btn-primary d-inline-flex align-item-center">
                      ...
                      <td class="text-center">
                        <ul class="list-inline me-auto mb-0">
                          <li class="list-inline-item align-bottom">
                            <a href="{{ url('faq/'.$item->id.'/edit') }}" class="avtar avtar-xs btn-link-primary">
...
<script>
  function confirmDelete(id) {
      ...
      form.action = "/faq/" + id; // Mengatur action form delete
