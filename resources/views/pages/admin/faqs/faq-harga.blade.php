    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col-xl-8">
              ...
              <div class="row align-items-center">
                <div class="col-md-12">
                  <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0)">FAQs Harga & Pembayaran</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="mb-4">
              <h1>FAQs Harga & Pembayaran</h1>
              <p class="text-muted">FAQ Harga & Pembayaran berisi informasi terkait biaya layanan, metode pembayaran yang tersedia, kebijakan pengembalian dana, serta pertanyaan lain yang sering diajukan pelanggan terkait transaksi di platform logistik.</p>
            </div>
            <!-- [ Search Form ] start -->
