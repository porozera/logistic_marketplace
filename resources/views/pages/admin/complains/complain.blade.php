            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Manajemen Komplain</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Manajemen Komplain</h2>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <table id="basic-btn" class="table nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @php
                                $badgeClass = $complain->status === 'Solved' ? 'bg-light-success' : 'bg-light-warning';
                            @endphp
                          ...
                          <td class="text-center">
                            <a href="{{ route('admin.complain.detail', ['id' => $complain->id]) }}" class="btn btn-primary btn-sm py-2 px-3 rounded-2">
                              Lihat Detail
                            </a>
                          </td>
                        </tr>
